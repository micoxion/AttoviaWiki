...
> [!info]+ Beginning of the Fire Tending
...
## Luminance
> [!example]+ Luminance
> The luminance of the fire will fluctuate during the night based on the actions made by players and attacks from outside forces. It has six stages listed below. At the beginning of nightfall the fire is Burning. If a [[#Fire Rounds|Fire Round]] goes by and neither the [[#Coax the Flame]] or [[#Feed the Flame]] action has been completed by default the Luminance decreases by one.

| Status                  | Luminance     | Effects                                                                                                                                                                                                                             |
| ----------------------- | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <input type="checkbox"> | Blazing       | Same as below plus all players immune to [[Until Dawn (5e Oneshot)#Chilled\|Chilled]] and Light cannot be in [[Until Dawn (5e Oneshot)#Complication\|Complication]]. During combat all Fire Tenders have advantage on Attack rolls. |
| <input type="checkbox"> | Dancing       | Advantage on checks made to [[Until Dawn (5e Oneshot)#Brave the Night\|Brave the Night]]                                                                                                                                            |
| <input type="checkbox"> | Burning       | -                                                                                                                                                                                                                                   |
| <input type="checkbox"> | Flickering    | [[Until Dawn (5e Oneshot)#Coax the Flame\|Coax the Flame]] and [[Until Dawn (5e Oneshot)#Feed the Flame\|Feed the Flame]] require twice as many participants to complete.                                                           |
| <input type="checkbox"> | Smoldering    | Same as above plust disadvantage on checks made to [[Until Dawn (5e Oneshot)#Brave the Night\|Brave the Night]] and Light cannot be in [[Until Dawn (5e Oneshot)#Abundance\|Abundance]].                                            |
| <input type="checkbox"> | Dead as Night | Same as above plus all players must take the [[Until Dawn (5e Oneshot)#Reignite\|Reignite]] action, have Disadvantage on Constitution saving throws, and Heat cannot be in [[Until Dawn (5e Oneshot)#Abundance\|Abundance]].        |
## Resources
> [!example]+ Resources
...
| Resource | Abundance               | Complication            |
| -------- | ----------------------- | ----------------------- |
| Fuel     | <input type="checkbox"> | <input type="checkbox"> |
| Morale   | <input type="checkbox"> | <input type="checkbox"> |
| Light    | <input type="checkbox"> | <input type="checkbox"> |
| Heat     | <input type="checkbox"> | <input type="checkbox"> |
#### Abundance
> [!example]+ Abundance
...
#### Reignite
> [!example]+ Reignite
> This action is not available unless [[#Luminance]] is at or below Smoldering. All players must participate in this action together during a [[#Fire Rounds|Fire Round]]. If any player is unable to participate in this action it cannot be completed. Each player rolls a DC 10 (if Morale is in [[#Complication]] roll at disadvantage) Survival check, no matter what the [[#Luminance]] level resets to Burning, but if at least three players fail the check Fuel's status becomes [[#Complication]].
#### Fraternize
> [!example]+ Fraternize
...
|  3   | What embarrasing thing did you see them doing?                                                                             |
...
|  15  | What's the last piece of advice they gave you?                                                                             |
|  16  | What did you overhear them saying about another person?                                                                    |
|  17  | How would you improve their appearance to help them find a mate?                                                           |
|  18  | What' the last piece of advice you gave them?                                                                              |
|  19  | Why do you trust them?                                                                                                     |
...
#### Rest
> [!example]+ Rest
> You may spend a [[#Fire Rounds|Fire Round]] doing nothing but resting and warming yourself by the flame. You may use one hit dice to regain hp, and have advantage on Constitution and Charisma Saving Throws until the start of the next [[#Fire Rounds|Fire Round]]
### Important Events and Environment Changes
> [!note]+ Events
> Events occur *before* the start of the [[#Fire Rounds|Fire Round]] they are listed in. Any status effect they inflict begins at the start of that same round.

> [!note]+ Optional Events
> Any event followed by (Optional) should be used at the DMs discretion. If your player's are getting good rolls and fending off the dark abnormally well, throw in some Optional events to increase [[#Special Status Effects|status effects]], and [[#Complication|Complications]]. Try to keep the tension up!

| Current Round           | Round | Event/Change                                                                   |
| ----------------------- | ----- | ------------------------------------------------------------------------------ |
| <input type="checkbox"> | 1     | -                                                                              |
| <input type="checkbox"> | 2     | -                                                                              |
| <input type="checkbox"> | 3     | [[Until Dawn (5e Oneshot)#A Strange Calm\|A Strange Calm]]                     |
| <input type="checkbox"> | 4     | [[Until Dawn (5e Oneshot)#A Sudden Chill\|A Sudden Chill]]                     |
| <input type="checkbox"> | 5     | -                                                                              |
| <input type="checkbox"> | 6     | -                                                                              |
| <input type="checkbox"> | 7     | [[Until Dawn (5e Oneshot)#Olavi's Double Checks In\|Olavi's Double Checks In]] |
| <input type="checkbox"> | 8     | -                                                                              |
| <input type="checkbox"> | 9     | -                                                                              |
| <input type="checkbox"> | 10    | -                                                                              |
| <input type="checkbox"> | 11    | [[Until Dawn (5e Oneshot)#Cacophony of Whispers\|Cacophony of Whispers]]       |
| <input type="checkbox"> | 12    | -                                                                              |
| <input type="checkbox"> | 13    | -                                                                              |
| <input type="checkbox"> | 14    | [[Until Dawn (5e Oneshot)#Zitón Speaks\|Zitón Speaks]]                         |
| <input type="checkbox"> | 15    | -                                                                              |
| <input type="checkbox"> | 16    | -                                                                              |
| <input type="checkbox"> | 17    | -                                                                              |
| <input type="checkbox"> | 18    | -                                                                              |
| <input type="checkbox"> | 19    | [[Until Dawn (5e Oneshot)#Shower of Boulders\|Shower of Boulders]]             |
| <input type="checkbox"> | 20    | [[Until Dawn (5e Oneshot)#Zitón Goads (Optional)\|Zitón Goads (Optional)]]     |
| <input type="checkbox"> | 21    | -                                                                              |
| <input type="checkbox"> | 22    | -                                                                              |
| <input type="checkbox"> | 23    | [[Until Dawn (5e Oneshot)#Phantasmal Illusions\|Phantasmal Illusions]]         |
| <input type="checkbox"> | 24    | -                                                                              |
| <input type="checkbox"> | 25    | [[Until Dawn (5e Oneshot)#Flash Flood (Optional)\|Flash Flood (Optional)]]     |
| <input type="checkbox"> | 26    | -                                                                              |
| <input type="checkbox"> | 27    | -                                                                              |
| <input type="checkbox"> | 28    | [[Until Dawn (5e Oneshot)#Zitón Shows Himself\|Zitón Shows Himself]]           |
| <input type="checkbox"> | 29    | -                                                                              |
| <input type="checkbox"> | 30    | -                                                                              |
| <input type="checkbox"> | 31    | -                                                                              |
| <input type="checkbox"> | 32    | -                                                                              |
| <input type="checkbox"> | 33    | [[Until Dawn (5e Oneshot)#Zitón's Wrathful Smite\|Zitón's Wrathful Smite]]     |
...
###### Chilled
> [!danger]+ Chilled
> At the start of each [[#Fire Rounds|Fire Round]] make a DC 10 Constitution Saving Throw, on a success you are no longer Chilled. If Heat is in [[#Abundance]] you make this Saving Throw with advantage. While Chilled you must make a DC 10 Survival check to participate in [[#Coax the Flame]] or [[#Feed the Flame]], on a failure instead of Fuel becoming [[#Complication|Complicated]] the action simply doesn't yield any benefits. Disadvantage on all Dexterity checks and saving throws. 
###### Overcast Heart
> [!danger] Overcast Heart
> At the start of each [[#Fire Rounds|Fire Round]] make a DC 13 Charisma Saving Throw, on a failure you are unable to participate in any joint activity for that round. On a success this effect ends. If Morale is in [[#Abundance]] you make this Saving Throw with advantage.
###### Overwhelming Terror
> [!danger]+ Overwhelming Terror
...
> >[!example] Effects
> > Luminance -1 at the start of this round. All characters roll DC 8 Constitution saving throws or become [[#Chilled]] for one round.
###### Olavi's Double Checks In
> [!info]+ Olavi's Double Checks In
...
> [!info]+ Olavi's Doppelganger Changing
...
> > [!example] Doppelganger Stats
> > ![[Pasted image 20241025164631.png]]
>
> > [!example] Effects
> > At the start of future [[#Fire Rounds]] if the Doppelganger's body remains in the fire's light Morale is placed into [[#Complication]]
###### Cacophony of Whispers
> [!info]+ Cacophony of Whispers
...
> > [!example] Effects
> > Each character must roll a DC 15 Charisma Saving Throw or hear their deepest regrets, their greatest fears, and their gravest sorrows. If at least two fail the check Morale's status becomes [[#Complication]]. Any player who fails gains the [[#Overcast Heart]] status.
###### Zitón Speaks
> [!info]+ Zitón Speaks
...
> 
> > [!example] Effects
> > Each character must roll a DC 15 Charisma Saving Throw or gain the [[#Overwhelming Terror]] status. Morale's status becomes [[#Complication]].
###### Shower of Boulders
> [!info]+ Shower of Boulders
...
> > In addition [[#Luminance]] decreases by one, and Fuel's status becomes [[#Complication]]
...
> 
> > [!example] Effects
> > Zitón summons two Dust Mephit's within the circle of light. On their first turns the Mephit's will attempt to use their Blinding Breath on the fire. If they succeed each reduces Luminance by one. If both succeed Light is put into [[#Complication]].
> > ![[Pasted image 20241026115644.png]]

###### Phantasmal Illusions
> [!info]+ Phantasmal Illusions
...
> > [!example] Effects
> > Each Fire Tender must roll a DC 15 Intelligence saving throw. On a failed save they are under the effects of the Phantasmal Force Spell and are also considered to have been in combat for this [[#Fire Rounds|Fire Round]]
> > ![[Pasted image 20241026121420.png]]
...
> > [!example] Effects
> >  [[#Luminance]] is reduced by two, Light and Heat become a [[#Complication]]. and all creatures standing in the muck have disadvantage on Dexterity Saving Throws.
> >  The strange fluid does not go away on its own, but can be removed using either a spell or a [[#Brave the Night]] action. If the fluid is still present at the start of a [[#Fire Rounds|Fire Round]] Luminance decreases by 1.
###### Zitón Shows Himself
> [!info]+ Zitón Shows Himself
...
> 
> > [!example] Effects
> > Combat begins against Zitón. He will flee if his HP falls below 20. He also has an additional two legendary actions which he may use to take the Life Drain or Create Specter action. If [[#Luminance]] is at least Dancing all of the Wraith's enemies have advantage to hit. If [[#Luminance]] is at or below smoldering the Wraith has advantage to strike his enemies.
> > ![[Pasted image 20241026130911.png]]

> [!info]+ Zitón Is Rebuffed
...
> 
> > [!example] Effects
> > [[#Chilled]] becomes Smoldering, all characters must roll a DC 14 Constitution saving Throw or become [[#Chilled]]. Heat, Light, and Fuel become a [[#Complication]].
